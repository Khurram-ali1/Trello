...
function CardAdd(props) {
  ...
  return (
    <div className='flex flex-col'>
       {show && <div>
            <textarea value={card} onChange={(e)=>setCard(e.target.value)} className='p-1 w-full rounded-md border-2 bg-zinc-700 border-zinc-900' placeholder='Enter Card Title...' name="" id="" cols={30} rows={2}></textarea>
